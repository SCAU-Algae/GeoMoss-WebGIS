...
<head>
    ...
    <script type="text/javascript" cesium="true" src="https://api.tianditu.gov.cn/demo/sanwei/static/cesium/Cesium"></script>
...
//三维图标服务
wtfs.getIconUrl = function(){
    return tdtUrl + 'mapservice/GetIcon?id={id}&tk=' + token;
}

wtfs.initDT({
    "x":6,"y":1,"level":2,"boundBox":{"minX":90,"minY":0,"maxX":135,"maxY":45},{"x":7,"y":1,"level":2,
});
</script>
```
